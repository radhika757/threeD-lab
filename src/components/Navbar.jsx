      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8 relative">
          ...
          <div className="relative group">
            <button className="text-black font-bold hover:text-blue-500 transition-all duration-300 hover:scale-110 transform">
              Style
            </button>
            ...
            <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md z-10
                ...
                transition-opacity duration-300 max-h-60 overflow-y-auto">
              <ul className="py-2">
                  <li>
                    <a
                      href="/scolling-effects"
          ...
          <Link
            href="#"
            className="text-black font-bold hover:text-green-500 transition-all duration-300 hover:scale-110 transform"
          >
            SHARE
          </Link>
        </div>
